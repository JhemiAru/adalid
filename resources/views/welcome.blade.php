...
<body>
    ...
    <div class="main">
        <div class="cards">
            ...
            <div class="card inventario"><h4>Inventario Total</h4><p id="valorTotalInv">0 Bs</p></div>
        </div>
            ...
            <div class="box box-oscura">
                ...
                <div class="donut-wrapper">
                    ...
                    <div class="donut-center">
                        <small style="color:#aaa">Unidades Totales</small><br>
    ...
    <script>
        ...
        let ing = 0, egr = 0;
        let valorAcumuladoInventario = 0; 
        let unidadesTotalesStock = 0; // Nueva variable para sincronizar la dona
        ...
        function registrar(t) {
            let val = parseFloat(prompt("Monto del " + t + ":"));
            if(!isNaN(val)) {
                if(t === 'Ingreso') ing += val; else egr += val;
                document.getElementById("listaMovs").innerHTML += `<tr><td>${t}</td><td>${val} Bs</td></tr>`;
                document.getElementById("totalIngresos").innerText = ing + " Bs";
                document.getElementById("totalEgresos").innerText = egr + " Bs";
                document.getElementById("totalCaja").innerText = (ing - egr) + " Bs";
            }
        }
        ...
        function agregarProd() {
            ...
            if(n && !isNaN(s) && !isNaN(p)) {
                let totalProducto = s * p;
                
                // Actualizar acumuladores
                valorAcumuladoInventario += totalProducto;
                unidadesTotalesStock += s; // Sumamos las unidades al total
                
                // Actualizar la tabla
                document.getElementById("tablaInv").innerHTML += `<tr><td>${n}</td><td>${s}</td><td>${p} Bs</td><td>${totalProducto} Bs</td></tr>`;
                
                // ACTUALIZAR INTERFAZ
                // 1. Tarjeta superior de Valor Monetario
                document.getElementById("valorTotalInv").innerText = valorAcumuladoInventario.toLocaleString() + " Bs";
                
                // 2. Centro de la dona (Sincronización de unidades)
                document.getElementById("donutStockCenter").innerText = unidadesTotalesStock.toLocaleString();
            }
        }
        ...
        new Chart(document.getElementById('donutChart'), {
            ...
            data: {
                datasets: [{
                    data: [100, 0, 0], // Inicialmente 100% en una categoría si está vacío
